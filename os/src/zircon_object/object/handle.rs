...
impl HandleBasicInfo {
    pub fn koid_test(&self) -> u64 {
        self.koid
    }
    pub fn rights_test(&self) -> u32 {
        self.rights
    }
    pub fn obj_type_test(&self) -> u32 {
        self.obj_type
    }
    pub fn related_koid_test(&self) -> u64 {
        self.related_koid
    }
    pub fn props_test(&self) -> u32 {
        self.props
    }
    pub fn padding_test(&self) -> u32 {
        self.padding
    }
}
