...
macro_rules! kcounter {
    ($var:ident, $name:expr) => {
        ...
        static $var: $crate::zircon_object::util::kcounter::KCounter = {
            #[used]
            #[cfg_attr(target_os = "none", link_section = ".kcounter.descriptor")]
            static DESCRIPTOR: $crate::zircon_object::util::kcounter::KCounterDescriptor =
                $crate::zircon_object::util::kcounter::KCounterDescriptor {
                    counter: &$var,
                    name: $name,
                };
            $crate::zircon_object::util::kcounter::KCounter::new()
        };
    };
}
